...
export default function CouponsPage() {
  ...
  if (!user || loading) return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--bg)' }}>
      <motion.div animate={{ opacity: [0.3, 0.7, 0.3] }} transition={{ duration: 1.8, repeat: Infinity, ease: 'easeInOut' }} className="flex flex-col items-center gap-3">
  ...
  return (
    <div className="relative min-h-screen">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {filtered.length === 0 ? (
            ...
            <motion.div
              ...
              /* Centred flex — lone cards sit in the middle, 3+ tile into a row */
      ...
      <footer className="relative z-10 py-16 px-6">
        <div className="max-w-3xl mx-auto">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2, delay: 0.4 }} className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
            <p className="font-serif-light" style={{ fontSize: 'clamp(18px, 3vw, 26px)', color: 'rgba(255,250,242,0.22)' }}>Every day with you is my favourite day.</p>
